# https://medium.com/the-ai-forum/mixture-of-agents-using-groq-09e2d46f3ce7
#########################bot.py####################
import datasets
...
"""
#### Place your Groq proposal models here
...
### Specify your GroqAggregator model here
def main(
    ...
    while True:
        ...
        if instruction == "exit" or instruction == "quit":
            ...
            break
        if multi_turn:
            # Reset references only once before appending new instructions
